...
} from "./chunk-VR67BXC7.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-ZGSHF32Z.js";
...
import {
  attachComponent,
  detachComponent
} from "./chunk-DXYKZUGR.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-YSPFSBP7.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-LPBDPYNG.js";
import {
  shouldUseCloseWatcher
} from "./chunk-KZT63QJA.js";
import {
  transition
} from "./chunk-U3LUY54I.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-2BP5QD23.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-QZEN2RTA.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-ABRCIECX.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-LE75OKDK.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-VS3JN3S2.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-DCWQKE3B.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-RILTOEWW.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
//# sourceMappingURL=ion-app_8.entry-B4DKDTRI.js.map
